...
#load all files into memory, see if multiprocessing can access it (doesn't work)
# global subx_all
# subx_all_together = xr.open_mfdataset(f'{home_dir}/{var}*.nc4', concat_dim=['S'], combine='nested').persist()
                    ...
                    def find_anomaly_with_weekly_mean(all_mean_var_mod,test_arr,anomaly_spread=42):
                        ...
                        for mod in all_mean_var_mod.keys():
                            ...
                            for k, julian_d in enumerate((all_mean_var_mod[mod])):
                                ...
                                #Save the mean. Create another script that simply subtracts
