...
merra_file = xr.open_dataset(f'{obs_dir}/temperature.nc4')
temp_merra = merra_file.T2MMEAN.to_dataset()
temp_merra.to_netcdf(f'{obs_dir}/temp_mean.nc4')
n_processors = 10
...
# _date='1999-12-06'
#%%
def convert_temp_OBS_to_SubX(_date) -> float:   
    var='tas'
    ...
    # os.system(f'mkdir -p {output_obs_dir}')
    obs_radiation = xr.open_dataset(f'{obs_dir}/temp_mean.nc4')
...
if __name__ == '__main__':
    p = Pool(n_processors)
    p.map(convert_temp_OBS_to_SubX,date_list)
#%%
