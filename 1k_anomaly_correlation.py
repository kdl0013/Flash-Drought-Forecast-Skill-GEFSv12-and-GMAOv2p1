...
def setup_plot(all_cluster_acc,cluster_num):
...
all_vals_setup_RZSM = {}
for clus_num in np.arange(1,7):
    all_vals_setup_RZSM[f'Cluster {clus_num}'] = setup_plot(all_cluster_acc=all_cluster_acc_RZSM,cluster_num=clus_num)


all_vals_setup_ETo = {}
for clus_num in np.arange(1,7):
    all_vals_setup_ETo[f'Cluster {clus_num}'] = setup_plot(all_cluster_acc=all_cluster_acc_ETo,cluster_num=clus_num)
...
RZSM_acc_values_to_plot,max_all, min_all = plot_lead_week_season_model(all_vals_setup=all_vals_setup_RZSM)
