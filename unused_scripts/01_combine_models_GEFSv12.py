...
gefs_dir = f'{home_dir}/EMC/raw_ensemble_files'

save_out_dir_GEFS = f'{home_dir}/EMC/combined_ensembles_GEFS'
...
template_subx=xr.open_dataset('/home/kdl/Insync/OneDrive/NRT_CPC_Internship/Data/SubX/GMAO/mrso_GMAO_2015-02-09.nc')
# #0-10 day
