...
#%%
if __name__ == '__main__':
    print('Converting SMERGE SM to SubX dimensions.')
    p = Pool(num_processors)
...
def ETo_plot_setup(date_list):
    
    correlation_ETo = flatten_ETo(date_list)    
    correlation_ETo_realization_mean = (average_realization_ETo(date_list))
