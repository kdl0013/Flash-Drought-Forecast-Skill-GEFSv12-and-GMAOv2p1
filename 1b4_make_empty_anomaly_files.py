...
def make_empty_multi_member_ensemble_files(init_date_list = init_date_list,T_FILE = T_FILE, var=var,out_lead=out_lead):
    ...
    for _date in init_date_list:
        ...
        if var == 'EDDI':
            filename = 'EDDI_MME'
            desc = 'Multi-member ensemble mean. Evaporative Demand Drought Index. Calculated by lead week (1-6) over all 15 years of dataset. Weekly leads of \
                1,2,3,4, mean 3&4, mean 3&4&5, mean 4&5&6'''
            for model in [0,1,2,3]:
                model_dirs[f'Model {model}'] = f'{home_dir}/EDDI_mod{model}'
            ...
            desc2 = f'Multi-member ensemble mean. RZSM SubX {mod} model. Calculated by lead week (1-6) over all 15 years of dataset. Weekly leads of \
                1,2,3,4, mean 3&4, mean 3&4&5, mean 4&5&6'''                
            for model in [0,1,2,3]:
                model_dirs[f'Model {model}'] = f'{home_dir}/{var}_anomaly_mod{model}'
            ...
            desc2 = f'Multi-member ensemble mean. ETo anomaly SubX {mod} model. Calculated by lead week (1-6) over all 15 years of dataset. Weekly leads of \
                1,2,3,4, mean 3&4, mean 3&4&5, mean 4&5&6'''
