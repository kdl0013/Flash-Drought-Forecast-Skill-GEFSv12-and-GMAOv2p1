...
skillds = hindcast.verify(metric="crpss", comparison="m2o", dim="member", alignment="same_inits").persist()
#%%
...
def make_save_plots_all_models_seasons_leads(acc_values_to_plot,var,min_all,max_all):
    ...
    plt.savefig(f'{output_season_dir}/all_season_CRPSS_skill_{var}_{name_}_test2.tif',dpi=300)
