...
skillds = hindcast.verify(metric="acc", comparison="m2o", dim="member", alignment="maximize").persist()
#%%
...
def make_save_plots_all_models_seasons_leads(acc_values_to_plot,var,min_all,max_all):
    ...
    plt.savefig(f'{output_season_dir}/all_season_{metric}_skill_{var}_{name_}.tif',dpi=300)
